...
The generated HTML site can be previewed here: https://emaapps.github.io/rfd-dashboard/
...
- As a first step to using this template, 
  - change the project name in .cabal, flake.nix and hie.yaml files; then commit changes to Git.
      - To automate this, `mv rfd-dashboard.cabal myproject.cabal; nix run nixpkgs#sd -- rfd-dashboard myproject * */* .github/*/*`
- Configuration:
